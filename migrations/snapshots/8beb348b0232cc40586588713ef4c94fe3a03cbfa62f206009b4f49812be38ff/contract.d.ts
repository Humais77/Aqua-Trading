...
export type StorageHash =
  StorageHashBase<'8beb348b0232cc40586588713ef4c94fe3a03cbfa62f206009b4f49812be38ff'>;
export type ExecutionHash =
  ExecutionHashBase<'8f1f5a6af25e6b31dd028db4eb50d662ccc2ed4c64ea66c0c9355f8bd4b5a4bf'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly PaymentDetail: {
      ...
      readonly accountTitle: CodecTypes['pg/text@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly PaymentDetail: {
      ...
      readonly accountTitle: CodecTypes['pg/text@1']['input'];
...
export namespace Models {
  ...
  export type public_PaymentDetail = {
    id: CodecTypes['pg/uuid@1']['output'];
    method: 'BANK_TRANSFER' | 'EASYPAISA' | 'JAZZCASH' | 'RAAST';
    title: CodecTypes['pg/text@1']['output'];
    accountTitle: CodecTypes['pg/text@1']['output'];
...
export declare const models: {
  public: {
    ...
    PaymentDetail: Models.public_PaymentDetail;
  };
};
          ...
          readonly table: {
            readonly deposit: {
              ...
              uniques: readonly [
                ...
                { readonly columns: readonly ['transactionReference'] },
              ];
              indexes: readonly [
                {
            ...
            readonly paymentDetail: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['method'] }];
              indexes: readonly [];
              foreignKeys: readonly [];
            };
            readonly plan: {
      ...
      readonly public: {
        readonly models: {
          ...
          readonly PaymentDetail: {
            ...
            readonly storage: {
              readonly table: 'paymentDetail';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly method: { readonly column: 'method' };
                readonly title: { readonly column: 'title' };
                readonly accountTitle: { readonly column: 'accountTitle' };
