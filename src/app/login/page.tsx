  ...
  return (
    <main className="relative min-h-screen w-full overflow-hidden bg-white font-sans text-slate-800">
      ...
      <div className="relative z-10 mx-auto min-h-screen max-w-[1180px] px-5 pb-4 pt-7 sm:px-8">
        ...
        <section className="relative mx-auto mt-7 min-h-[500px] max-w-[1080px]">
          {/* =====================================================
              LEFT DECORATION
          ====================================================== */}

          <div className="absolute left-0 top-0 hidden h-full w-[250px] lg:block">
            {/* Tilted Better Tomorrow Card */}
          ...
          <div className="relative z-20 mx-auto w-full max-w-[410px]">
            <div className="rounded-[32px] border border-pink-200/80 bg-white/95 px-6 pb-7 pt-0 shadow-[0_15px_45px_rgba(237,19,133,0.14)] backdrop-blur-md sm:px-7">
              ...
              <div className="mt-6">
                <button
                  type="button"
                  className="flex w-full items-center justify-center gap-2 rounded-full border-2 border-pink-200 bg-white px-4 py-2.5 text-[11px] font-bold text-[#9e326c] shadow-[0_2px_7px_rgba(237,19,133,0.06)] transition hover:border-[#ed1385] hover:bg-pink-50"
                >
                  <KeyRound
                    size={14}
                ...
                <p className="mt-2 text-center text-[8px] font-medium text-slate-400">
                  Select your saved account to log in.
                </p>
              </div>
...
/>
                  ...
                  <p className="mt-1.5 pl-4 text-[7px] font-medium text-slate-400">
                    Use the username or email linked to your account.
                  </p>
                </div>
...
>
  ...
  <div className="rounded-xl border border-red-100 bg-red-50 px-4 py-3 text-center text-[9px] font-semibold text-red-600">
    {error}
        ...
        <section className="relative z-20 mx-auto mt-6 w-full max-w-[1050px] px-4 sm:mt-8">
  <div className="grid grid-cols-2 gap-x-8 gap-y-7 sm:grid-cols-4 sm:gap-x-12">
    <BottomFeature
      icon={<TrendingUp size={25} strokeWidth={2.5} />}
      title="Explore"
      subtitle="Investment Plans"
    />

    <BottomFeature
      icon={<ShieldCheck size={25} strokeWidth={2.5} />}
      title="Your"
      subtitle="Account"
    />

    <BottomFeature
      icon={<Users size={25} strokeWidth={2.5} />}
      title="Growing"
      subtitle="Community"
    />

    <BottomFeature
      icon={<Headset size={25} strokeWidth={2.5} />}
      title="Contact"
      subtitle="Support"
    />
  </div>
